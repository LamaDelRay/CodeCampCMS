...
<iframe src="http://www.facebook.com/plugins/like.php?href=http://'. $elpermalink_toolbarf .'
...
<script type="text/javascript">
  ...
  if ($publi_toolbar1_toolbar == 'Si'){  
     ...
     $banner_toolbar= $banner_toolbar . '  
        ...
        <a href="http://www.comprarproteinas.info/" title="Comprar comprarproteinas.info" target="_blank">Comprar Proteinas</a>
        </div>';

} 
   else { 
    $banner_toolbar= $banner_toolbar .' <div align="right" id="divletra" class="divletra" >Ver. 1.3</div> ';
   }
